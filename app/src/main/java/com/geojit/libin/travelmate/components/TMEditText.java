...
public class TMEditText extends EditText {
    ...
    public TMEditText(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    public TMEditText(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
